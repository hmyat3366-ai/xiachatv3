    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-xs animate-in fade-in duration-150">
      <div className="bg-white rounded-3xl border border-[#E8E8E5] max-w-md w-full p-6 shadow-xl space-y-4">
        ...
        <div className="space-y-1">
          <h3 className="text-lg font-extrabold text-[#171717]">Delete "{agentName}"?</h3>
          <p className="text-xs text-[#6B6B6B] leading-relaxed">
            This agent will stop handling conversations. Existing customer conversation history will not be deleted.
          </p>
        </div>
